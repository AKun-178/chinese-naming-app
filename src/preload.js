...
contextBridge.exposeInMainWorld("desktopApi", {
  ...
  selectTailVideo: () => ipcRenderer.invoke("dialog:tailVideo"),
  selectTailBackground: () => ipcRenderer.invoke("dialog:tailBackground"),
  ...
  buildTailVideo: (payload) => ipcRenderer.invoke("tail:build", payload),
